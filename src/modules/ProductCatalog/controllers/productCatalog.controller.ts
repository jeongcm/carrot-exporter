...
class ProductCatalogController {
  ...
  public createCatalogPlansProduct = async (req: IRequestWithUser, res: Response, next: NextFunction) => {
    try {
      ...
      const catalogPlanDetails: ICatalogPlan = await this.productCatalogService.findCatalogPlanOnly(productData.catalogPlanId);
  ...
  public createPlanProductPricing = async (req: IRequestWithUser, res: Response, next: NextFunction) => {
    try {
      ...
      const newPricingData: ICatalogPlanProductPrice = await this.productCatalogService.createProductPricing(
        pricingData,
        planProductDetails.catalogPlanProductKey,
        partyId,
        systemId,
      );
