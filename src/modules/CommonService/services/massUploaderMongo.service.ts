...
class massUploaderMongoService {
    ...
    public async massUploadResourceMongo(resourceMassFeed: any): Promise<object> {
        ...
        const mongoUrl = "mongodb://nc_api:nc_api@localhost:27017/nc_api"
        ...
        //update mariadb resource table
            ...
            console.log (resource_delete_maria);
        ...
        //up-seart
            for (let i=0; i<itemLength; i++)
            {
                ...
                var query_search = {resource_Target_Uuid: resourceMassFeed[i].resource_Target_Uuid};
                ...
                // update Mariadb....    
                    const result_update_maria = await this.resourceService.updateResourceByMongoUploader(resourceMassFeed[i].resource_Target_Uuid);
