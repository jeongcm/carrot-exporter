...
import { CreateAlertEasyRuleDto, UpdateAlertEasyRuleDto, CreateAlertTargetGroupDto, CreateAlertTargetSubGroupDto } from '../dtos/alertEasyRule.dto';
...
class AlertEasyRuleService {
  ...
  public async updateAlertEasyRule(alertEasyRule: UpdateAlertEasyRuleDto, partyId: string): Promise<Object> {
    ...
    const updateQuery = {
      ...
      deletedAt: null,
      alertEasyRuleDescription: alertEasyRuleDescription,
