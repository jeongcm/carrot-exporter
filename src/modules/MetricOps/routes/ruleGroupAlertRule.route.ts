...
class RuleGroupAlertRoute implements Routes {
  ...
  private initializeRoutes() {
    this.router.post('/ruleGroup/alertRule/register', authMiddleware, validationMiddleware(RuleGroupAlertRuleDto, 'body'), this.ruleGroupAlertRuleController.registerAlertRule);
    this.router.post('/ruleGroup/alertRule/unregister', authMiddleware, validationMiddleware(UnRegisterRuleGroupAlertRuleDto, 'body'), this.ruleGroupAlertRuleController.unregisterAlertRule);
