...
class CommonCodeController {
  ...
  public createCommonCode = async (req: RequestWithUser, res: Response, next: NextFunction) => {
    try {
      ...
      const createCommonCodeData: ICommonCode = await this.commonCodeService.createCommonCode(commonCodeData);
  ...
  public getAllCommonCode = async (req: RequestWithUser, res: Response, next: NextFunction) => {
    try {
      const findAllCommonCodeData: CommonCodeDto[] = await this.commonCodeService.getAllCommonCodel();
  ...
  public updateCommonCode = async (req: RequestWithUser, res: Response, next: NextFunction) => {
    try {
      ...
      const updateCommonCodeData: ICommonCode = await this.commonCodeService.updateCommonCode(commonCodeId, commonCodeData, currentUserPk);
