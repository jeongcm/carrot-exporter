import {getRegionListQuery} from "@modules/Resources/formatter/ncp/region/region";
...
class FormatterService {
  ...
  public formatter_resource(i, itemLength, resourceType, cluster_uuid, query, mergedQuery) {
    let interimQuery = {};
    try {
      if (itemLength==1) {
