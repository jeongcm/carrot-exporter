...
class SubscriptionRoute implements Routes {
  ...
  private initializeRoutes() {
    this.router.post(
      ...
      this.subscriptionController.createSubscriptions,
    );
    ...
    this.router.put(
      ...
      authMiddleware,
      validationMiddleware(UpdateSubscriptionDto, 'body'),
      createUserLogMiddleware,
    ...
    this.router.post(
      '/subscribeProduct',
      authMiddleware,
      validationMiddleware(CreateSubscribedProductDto, 'body'),
      createUserLogMiddleware,
      this.subscriptionController.createSubscribeProduct,
    );
    this.router.get(
      '/subscribeProduct/:subscribedProductId',
      authMiddleware,
      createUserLogMiddleware,
      this.subscriptionController.getSubscribeProduct,
    );
    this.router.put(
      '/subscribeProduct/:subscribedProductId',
      authMiddleware,
      createUserLogMiddleware,
      this.subscriptionController.updateSubscribedProduct,
    );
  }
}
